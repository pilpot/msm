...
<form action="?/submitGuess" method="post" enctype="multipart/form-data" use:enhance style="display:flex;">
	<div style="display: flex;justify-content: flex-space-around; max-width: 189px;">
		<GameBoardPicker colors={colors} id="guess[0]" value={parseInt(guesspos0)}></GameBoardPicker>
		<GameBoardPicker colors={colors} id="guess[1]" value={parseInt(guesspos1)}></GameBoardPicker>
		<GameBoardPicker colors={colors} id="guess[2]" value={parseInt(guesspos2)}></GameBoardPicker>
		<GameBoardPicker colors={colors} id="guess[3]" value={parseInt(guesspos3)}></GameBoardPicker>
		<GameBoardPicker colors={colors} id="guess[4]" value={parseInt(guesspos4)}></GameBoardPicker>
	</div>
